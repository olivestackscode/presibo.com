...
class EnvironmentConfig {
  constructor() {
    this.config = {
      ...
      ANTHROPIC_API_KEY: this.getEnvVar('ANTHROPIC_API_KEY', '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'),
